					...
					<div class="loading-screen">
						{#if drinkProfile.type === 'martini'}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect class="liquid-fill" x="0" y="40" width="72" height="50" fill={drinkProfile.color} opacity="0.7" clip-path="url(#martini-clip)" />
						...
						{:else if drinkProfile.type === 'boba'}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect class="liquid-fill" x="0" y="58" width="72" height="50" fill={drinkProfile.color} opacity="0.65" clip-path="url(#boba-clip)" />
						...
						{:else if drinkProfile.type === 'coffee'}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect class="liquid-fill" x="0" y="58" width="72" height="50" fill={drinkProfile.color} opacity="0.7" clip-path="url(#coffee-clip)" />
						...
						{:else if drinkProfile.type === 'tall' || drinkProfile.type === 'highball'}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect class="liquid-fill" x="0" y="58" width="72" height="50" fill={drinkProfile.color} opacity="0.65" clip-path="url(#tall-clip)" />
						...
						{:else}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect class="liquid-fill" x="0" y="50" width="72" height="50" fill={drinkProfile.color} opacity="0.65" clip-path="url(#cup-clip)" />
