					...
					<div class="loading-screen">
						{#if drinkProfile.type === 'martini'}
							<svg class="loading-svg" viewBox="0 0 72 88" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<g clip-path="url(#martini-clip)">
									<rect class="liquid-fill" x="-4" y="0" width="80" height="88" fill={drinkProfile.color} opacity="0.7" />
								</g>
...
<style>
	...
	.liquid-fill {
		animation: liquid-rise 1.6s ease-in-out infinite alternate;
	}
